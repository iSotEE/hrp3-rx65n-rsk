 ...
 *  の責任を負わない．
 * 
 *  $Id: test_lmtdom1.c 444 2018-08-17 16:21:02Z ertl-hiro $
 */
 ...
 *		ており，指定できる最高のタスク優先度がTMIN_TPRI+3の保護ドメイン
 ...
 * 【使用リソース】
 *
 *	DOM1: アクセス許可ベクタ：デフォルト，指定できる最高のタスク優先度：
 *		  デフォルト
 *	DOM2: アクセス許可ベクタ：デフォルト，指定できる最高のタスク優先度：
 *		  TMIN_TPRI+1
 *	DOM3: アクセス許可ベクタ：DOM1とDOM3からの通常操作2が許可，指定でき
 *		  る最高のタスク優先度：デフォルト
